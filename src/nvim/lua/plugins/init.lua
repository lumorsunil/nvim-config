...
local lazy_specs = {
  ...
  treesitter_manager = {
    ...
    event = "User InitAllDone",
    opts = {
      auto_install = true, -- Natively downloads missing parsers like JSON on the fly
    },
  },
  url_open = {
    enabled = true,
  ...
  lush = {
    ...
    config = function()
      ...
      vim.api.nvim_create_user_command("Lushify", function()
        ...
        lush.ify()
        vim.keymap.set("n", "<leader>li", "<cmd>redir @\" | silent exe 'Inspect' | redir END | silent normal! p <cr>")
      end, { force = true })
    end,
    dependencies = {
  ...
  go = {
    ...
    dependencies = { -- optional packages
      ...
      -- NOTE: logs out info that nvim-treesitter module is not loaded (nvim 0.12 you don't need nvim-treesitter anymore)
      -- "nvim-treesitter/nvim-treesitter",
    },
    config = function()
      require("go").setup()
  ...
  runic = {
    dir = "/home/lumorsunil/runic/editor/neovim",
